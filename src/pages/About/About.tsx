...
export const AboutPage = () => {
    return (
        <div className="bg-brand-bg">
            {/* 1. Hero Section */}
            <section id="about-section" className="text-center py-20 px-4">
                <h1 className="font-besley text-5xl md:text-7xl font-bold text-brand-dark leading-tight">
            ...
            {/* 2. Our Story Section */}
            <section className="bg-brand-green text-brand-light py-20 px-4">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center leading-9">
                    <div>
                        <h2 className="font-besley text-4xl font-bold">Born from the Kitchen, Not the Boardroom.</h2>
            ...
            <section className="py-20 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="font-besley text-4xl font-bold text-brand-dark">What We Stand For</h2>
            ...
            <section className="bg-brand-dark py-20 px-4 text-center">
                 <h2 className="font-besley text-4xl font-bold text-brand-light">Ready to Transform Your Restaurant?</h2>
