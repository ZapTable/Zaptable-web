...
export const PricingPage = () => {
  return (
    // 1. Reduced vertical padding for mobile (py-16), larger for medium screens up (md:py-24)
    <section id="pricing-section" className="py-16 md:py-24">
      <div className="max-w-9xl mx-auto px-4 sm:px-6">
        {/* 2. Reduced padding on mobile (p-6), larger for medium screens up (md:p-12) */}
        <div className="bg-gray-200 rounded-3xl shadow-xl p-6 md:p-12">
          <div className="container relative z-10 max-w-2xl mx-auto text-center">
            {/* 3. Made font sizes responsive */}
            <h2 className="font-600 text-3xl md:text-4xl text-brand-green">Choose the right plan for your restaurant</h2>
            <p className="font-400 text-lg md:text-xl text-brand-gray max-w-2xl mx-auto mt-4">
              From small cafes to multi-outlet chains — we’ve got a plan that scales with your business.
            </p>
          </div>

          {/* 4. This flex-wrap layout is already mobile-friendly. It will automatically stack the cards vertically on small screens. No changes needed here! */}
